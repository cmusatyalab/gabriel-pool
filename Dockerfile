...
WORKDIR /
RUN git clone https://github.com/cmusatyalab/gabriel-pool.git
...
CMD ["bash", "-c", "gabriel-control -d -n eth0 -l & sleep 5; gabriel-ucomm -s 127.0.0.1:8021 & sleep 5;  cd /gabriel-pool && python proxy.py -s 127.0.0.1:8021"]
